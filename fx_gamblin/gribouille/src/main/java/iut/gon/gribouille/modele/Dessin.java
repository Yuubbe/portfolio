...
public class Dessin {
	...
	private SimpleObjectProperty fichier = new SimpleObjectProperty();
	...
	/**
	 * Sauvegarde le dessin dans le fichier spécifié. Change le nom du dessin si
	 * succès.
	 */
	...
	/**
	 * Charge le dessin depuis le fichier spécifié. Change le nom du dessin si
	 * succès.
	 * 
